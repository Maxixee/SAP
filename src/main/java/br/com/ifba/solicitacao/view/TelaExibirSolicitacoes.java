...
public class TelaExibirSolicitacoes extends javax.swing.JFrame {
    ...
    public void inserirDadosTela(){ // preenche a tabela com os dados do BD
        for(Agendamento agendamento : facade.getAllAgendamento()){
            Object[] solicitacoesAgendamento = {agendamento.getId(), agendamento.getNomePaciente(), agendamento.getMatriculaPaciente()};
            DefaultTableModel dtmUsuarios = (DefaultTableModel) TelaExibirSolicitacoes.this.getTblSolicitacoes().getModel();
            dtmUsuarios.addRow(solicitacoesAgendamento);
        }  
    }
